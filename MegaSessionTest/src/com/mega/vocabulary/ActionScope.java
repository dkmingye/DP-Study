...
public interface ActionScope extends GenericObject {
/*MetaClass ID*/
    public static String ID = "~nHkR5vdfEXFS[Action Scope]";
/*MetaAttributes*/
...
/*MetaAssociationEnds*/
    public static final String MAE_Action = "~uJkR(vdfELKS[Action Scope.Action]";
